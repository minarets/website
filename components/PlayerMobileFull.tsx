              ...
              <div className={styles.nowPlaying}>
                ...
                <div className={styles.playerControls}>
                  ...
                  <div className={styles.playerControlsButtons}>
                    ...
                    <button title="Previous" type="button" className={styles.controlButton} onClick={(): void => playerState.player.previousTrack()}>
                      <svg role="img" height="16" width="16" viewBox="0 0 16 16">
                    ...
                    <button title="Next" type="button" className={styles.controlButton} onClick={(): void => playerState.player.nextTrack()}>
                      <svg role="img" height="16" width="16" viewBox="0 0 16 16">
